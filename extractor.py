...
_THAI_TYPO_FIXES = {
    ...
    "บรษิ ัท ทรู มฟู เอช ยนู ิเวอรแ์ ซล คอมมิวนิเคช่นั จำ กดั ์": "บริษัท ทรู มูฟ เอช ยูนิเวอร์แซล คอมมิวนิเคชั่น จำกัด",
    "นำงสำวณฐั กำนต ์วงศส์ ำยเชือ้ ": นางสาวณัฐกานต์ วงศ์สายเชื้อ",
}
